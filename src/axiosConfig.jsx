...
const baseURL = process.env.REACT_APP_API_URL ||'http://localhost:5000';//'https://curia-backend.vercel.app';// 'http://localhost:5000';//'http://jeevankply.com:5000';//http://jeevankply.com:5000';'https://curia-backend.vercel.app';//
const axiosInstance = axios.create({
